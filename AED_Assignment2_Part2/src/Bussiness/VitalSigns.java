...
public String toString(){
        return "[ Name is "+ this.name+ ", Age is "+ this.age+ ", Heart Rate is  "+ this.heartRate +", Respiratory rate is  "+this.respRate +", Systolic Blood Pressure is "+this.systBP+ ", Weight in Kilos is "+this.wKg +", Weight in Pounds is "+this.wPnd+"]";
    }
