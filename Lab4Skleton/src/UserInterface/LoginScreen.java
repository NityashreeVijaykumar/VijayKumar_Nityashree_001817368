...
public class LoginScreen extends javax.swing.JPanel {
  ...
  User usr = (User) comboUser.getSelectedItem();
        if (usr != null) {
            if (usr.getRole().equalsIgnoreCase("supplier")) {
                Supplier s = (Supplier) usr;
   ...
   private void grantAccess(User usr) {
        SuccessScreen ss = new SuccessScreen(usr);
        CardLayout layout = (CardLayout) this.panelRight.getLayout();
        panelRight.add("Success screen", ss);
