...
public class ViewPanel extends javax.swing.JPanel {
    ...
    ViewPanel(JPanel userComponent, Product prod, ProductDirectory accDir ) {
        initComponents();
        this.product=prod;
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(45, 45, 45)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(txtAvailablity, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Please enter a valid Avail Number", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
            txtAvailablity.setEditable(false);
            txtPrice.setEditable(false);
...
//        layout.previous(userProcessContainer);
        ...
        Component [] comps = this.userComponent.getComponents();
