...
public class ProdManagementPanel extends javax.swing.JPanel {
    ...
    public ProdManagementPanel(JPanel userComponent,ProductDirectory accDir) {
        initComponents();
        this.accDir = accDir;
    ...
    CreateProductJPanel panel = new CreateProductJPanel(userComponent, accDir);
        userComponent.add("CreateProuctdJPanel", panel);
        CardLayout layout = (CardLayout) userComponent.getLayout();
        layout.next(userComponent);        // TODO add your handling code here:
        
    }//GEN-LAST:event_btnCreateActionPerformed

    private void btnManageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageActionPerformed
        // TODO add your handling code here:
         ManageProdPanel panel = new ManageProdPanel(userComponent, accDir);
        userComponent.add("ManageProdPanel", panel);
        CardLayout layout = (CardLayout) userComponent.getLayout();
